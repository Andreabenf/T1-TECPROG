...
def test_total_decucoes(dedu1, dedu2, dedu3, total):
    ...
    simuilacao.cadastrar_deducao(dedu1, "testeDeducao")
    simuilacao.cadastrar_deducao(dedu2, "testeDeducao")
    simuilacao.cadastrar_deducao(dedu3, "testeDeducao")
...
def test_1_faixa(dedu1, dedu2, rend1, rend2):
    ...
    simuilacao.cadastrar_deducao(dedu1, "testeDeducao")
    simuilacao.cadastrar_deducao(dedu2, "testeDeducao")
    simuilacao.cadastrar_rendimento(rend1, "testeRendimento")
    simuilacao.cadastrar_rendimento(rend2, "testeRendimento")
